...
Do **not** use our company name or “Patient Prism” anywhere in the repo name.  
Choose a neutral or creative name instead — for example:

- `calctek-calc`
- `vue-calc-ticker`
- `number-forge`

Avoid names like `patient-prism-calc` or anything with “prism” in it.
